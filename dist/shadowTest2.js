...
import { SimpleGouraudLambertProgram } from "./programs/complete/simpleGouraudLambertProgram.js";
...
function createGridInfo(glCtx, framebuffer) {
    ...
    shapeWireframe.addGeometry(new Grid(cellCount, (length - 0.1) / cellCount, cellCount, (length - 0.1) / cellCount));
    shapeWireframe.applyTransformation(new Transformation().translate(0, length / 4, -length / 2 + 0.05));
...
//# sourceMappingURL=shadowTest2.js.map