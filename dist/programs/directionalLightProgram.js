...
export class DirectionalLightProgram extends ProgramOld {
    constructor(glCtx, geometry, colour) {
        super(glCtx, new VertexShader(glCtx, DirectionalLightProgram.vertexShaderSource), new FragmentShader(glCtx, DirectionalLightProgram.fragmentShaderSource));
...
DirectionalLightProgram.vertexShaderSource = `#version 300 es
...
DirectionalLightProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=directionalLightProgram.js.map