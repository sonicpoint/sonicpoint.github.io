...
export class SimpleNormalMapProgram extends Program {
    constructor(glCtx, geometry, material) {
        super(glCtx, new VertexShader(glCtx, SimpleNormalMapProgram.vertexShaderSource), new FragmentShader(glCtx, SimpleNormalMapProgram.fragmentShaderSource));
...
SimpleNormalMapProgram.vertexShaderSource = `#version 300 es
...
SimpleNormalMapProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=simpleNormalMapProgram.js.map