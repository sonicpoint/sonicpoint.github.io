...
//
export class SimpleGoraudLambertProgram extends Program {
    constructor(glCtx, geometry, colour) {
        super(glCtx, new VertexShader(glCtx, SimpleGoraudLambertProgram.vertexShaderSource), new FragmentShader(glCtx, SimpleGoraudLambertProgram.fragmentShaderSource));
...
SimpleGoraudLambertProgram.vertexShaderSource = `#version 300 es
...
SimpleGoraudLambertProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=simpleGoraudLambertProgram.js.map