...
//
export class SimpleGoraudLambertToBufferProgram extends Program {
    constructor(glCtx, geometry, glFramebuffer, colour) {
        super(glCtx, new VertexShader(glCtx, SimpleGoraudLambertToBufferProgram.vertexShaderSource), new FragmentShader(glCtx, SimpleGoraudLambertToBufferProgram.fragmentShaderSource));
...
SimpleGoraudLambertToBufferProgram.vertexShaderSource = `#version 300 es
...
SimpleGoraudLambertToBufferProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=simpleGoraudLambertToBufferProgram.js.map