...
//
export class SimpleGouraudLambertToBufferProgram extends Program {
    constructor(glCtx, geometry, glFramebuffer, colour) {
        super(glCtx, new VertexShader(glCtx, SimpleGouraudLambertToBufferProgram.vertexShaderSource), new FragmentShader(glCtx, SimpleGouraudLambertToBufferProgram.fragmentShaderSource));
...
SimpleGouraudLambertToBufferProgram.vertexShaderSource = `#version 300 es
...
SimpleGouraudLambertToBufferProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=simpleGouraudLambertToBufferProgram.js.map