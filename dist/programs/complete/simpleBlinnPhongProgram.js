...
export class SimpleBlinnPhongProgram extends Program {
    constructor(glCtx, geometry, material) {
        super(glCtx, new VertexShader(glCtx, SimpleBlinnPhongProgram.vertexShaderSource), new FragmentShader(glCtx, SimpleBlinnPhongProgram.fragmentShaderSource));
...
SimpleBlinnPhongProgram.vertexShaderSource = `#version 300 es
...
SimpleBlinnPhongProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=simpleBlinnPhongProgram.js.map