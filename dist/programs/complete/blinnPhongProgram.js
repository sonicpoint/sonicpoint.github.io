...
export class BlinnPhongProgram extends Program {
    constructor(glCtx, geometry, material, lightCount) {
        super(glCtx, new VertexShader(glCtx, BlinnPhongProgram.getVertexShaderSource(lightCount)), new FragmentShader(glCtx, BlinnPhongProgram.getFragmentShaderSource(lightCount)));
    ...
    vec3 phongShading(int index) {
      ...
      vec4 ia = uLightInfo[index].Ia * uMaterialAmbient * uMaterialDiffuse;
      vec4 id = vec4(0.0, 0.0, 0.0, 1.0);
      vec4 is = vec4(0.0, 0.0, 0.0, 1.0);

      if (lambertTerm > 0.0) {
        id = uLightInfo[index].Id * lambertTerm * uMaterialDiffuse;
...
//# sourceMappingURL=blinnPhongProgram.js.map