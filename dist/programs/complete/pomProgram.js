...
export class PomProgram extends Program {
    constructor(glCtx, geometry, material, lightCount, layers, depthScale, reverseHeightMap) {
        super(glCtx, new VertexShader(glCtx, PomProgram.getVertexShaderSource(lightCount)), new FragmentShader(glCtx, PomProgram.getFragmentShaderSource(lightCount)));
...
//# sourceMappingURL=pomProgram.js.map