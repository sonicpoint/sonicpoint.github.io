...
export class MixedLightProgram extends ProgramOld {
    constructor(glCtx, geometry, material) {
        super(glCtx, new VertexShader(glCtx, MixedLightProgram.vertexShaderSource), new FragmentShader(glCtx, MixedLightProgram.fragmentShaderSource));
...
MixedLightProgram.vertexShaderSource = `#version 300 es
...
MixedLightProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//      fragColor += uColor;
      fragColor.rgb += vTempColor.rgb;
    }`;
//# sourceMappingURL=mixedLightProgram.js.map