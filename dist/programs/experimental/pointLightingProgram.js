...
export class PointLightProgram extends Program {
    constructor(glCtx, geometry, material) {
        super(glCtx, new VertexShader(glCtx, PointLightProgram.vertexShaderSource), new FragmentShader(glCtx, PointLightProgram.fragmentShaderSource));
...
PointLightProgram.vertexShaderSource = `#version 300 es
...
PointLightProgram.fragmentShaderSource = `#version 300 es
  precision mediump float;
...
//# sourceMappingURL=pointLightingProgram.js.map