...
export class SimplePbrProgram extends Program {
    constructor(glCtx, geometry, material) {
        super(glCtx, new VertexShader(glCtx, SimplePbrProgram.vertexShaderSource), new FragmentShader(glCtx, SimplePbrProgram.fragmentShaderSource));
...
SimplePbrProgram.vertexShaderSource = `#version 300 es
...
SimplePbrProgram.fragmentShaderSource = `#version 300 es
    precision mediump float;
...
//# sourceMappingURL=pbrProgram.js.map